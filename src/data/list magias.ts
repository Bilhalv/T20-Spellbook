...
export const magiasListTEMPORARIA: magiaTipo[] = [
  ...
  },
  {
    ...
    aprimoramentos: [
      ...
      {
        pm: 1,
        desc: "Muda o alvo para 1 monstro ou espírito com Inteligência 1 ou 2",
      },
      {
        pm: 2,
        desc: "Aumenta o número de alvos em +1",
  ...
  },
  {
    ...
    aprimoramentos: [
      ...
      {
        pm: 7,
        desc: "Muda o parceiro para mestre. Requer 3º círculo",
      },
      {
        pm: 12,
        desc: "Muda o alvo para 2 animais prestativos. Cada animal funciona como um parceiro de um tipo diferente, e você pode receber a ajuda de ambos (mas ainda precisa seguir o limite de parceiros de acordo com o seu nível de personagem). Requer 4º círculo",
      },
    ],
    tipo: "Divina",
    circulo: 2,
  ...
  },
  {
    ...
    desc: "Esta magia aumenta ou diminui o tamanho de um item mundano em até três categorias (um objeto Enorme vira Pequeno, por exemplo). Você também pode mudar a consistência do item, deixando-o rígido como pedra ou flexível como seda (isso não altera sua RD ou PV, apenas suas propriedades físicas). Se lançar a magia num objeto de uma criatura involuntária, ela pode fazer um teste de Vontade para anulá-la",
    execucao: "Padrão",
    alcance: "Curto",
    alvo: "1 objeto",
    duracao: "1 dia",
  ...
  },
  {
    ...
    desc: "O alvo é envolvido por um campo de força cor de esmeralda que impede qualquer movimento planar. Isso inclui magias de convocação (como Salto Dimensional e Teletransporte), viagens astrais e a habilidade incorpóreo",
    execucao: "Padrão",
    alcance: "Curto",
    ...
    aprimoramentos: [
      {
        pm: 2,
        desc: "Muda o alcance para médio, a área para esfera com 3m de raio e o alvo para criaturas escolhidas",
      },
      {
        pm: 2,
      ...
      {
        pm: 4,
        desc: "Como acima, mas em vez de um fio, cria uma corrente de energia, com 20 PV e redução de dano 40",
      },
      {
        pm: 4,
        desc: "Muda o alvo para área de cubo de 9m, a duração para permanente e adiciona componente material (chave de esmeralda no valor de T$ 2.000). Em vez do normal, nenhum tipo de movimento planar pode ser feito para entrar ou sair da área",
      },
      {
        pm: 9,
        desc: "Muda o alcance para médio, a área para esfera com 3m de raio e o alvo para criaturas escolhidas. Cria um fio de energia (veja acima) que prende todos os alvos ao centro da área",
      },
    ],
    tipo: "Arcana",
    circulo: 3,
